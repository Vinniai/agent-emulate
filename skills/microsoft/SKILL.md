...
```bash
# Microsoft only
npx agent-emulate --service microsoft
...
```json
{
  ...
  "given_name": "Test",
  "family_name": "User",
  "preferred_username": "testuser@agent-emulate.dev"
}
```
...
```json
{
  ...
  "mail": "testuser@agent-emulate.dev",
  "userPrincipalName": "testuser@agent-emulate.dev",
  "id": "<oid>"
}
```
