...
export const metadata: Metadata = {
  metadataBase: new URL("https://github.com/Vinniai/agent-emulate#readme"),
  title: {
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://github.com/Vinniai/agent-emulate#readme",
    siteName: "emulate",
    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm dark:bg-neutral-950/90">
      <div className="flex h-14 items-center justify-between px-4 gap-6">
        ...
        <nav className="flex items-center gap-4">
          ...
          <a
            href="https://github.com/Vinniai/agent-emulate"
            target="_blank"
